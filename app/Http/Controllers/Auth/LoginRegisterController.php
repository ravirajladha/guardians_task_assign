...
class LoginRegisterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = Auth::user();
        $request->session()->put('guardian_auth_email', $user->email);
        $request->session()->put('guardian_auth_userid', $user->id);

        $request->session()->put('guardian_auth_user_name', $user->name);
        $request->session()->put('guardian_auth_user_type', $user->user_type);
...
dd("rtt");
            ...
            session()->put('guardian_auth_email', $request->email);
        }
